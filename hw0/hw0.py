...
#mnist.train.images(55000), mnist.train.labels(55000), mnist.test.images(10000), mnist.test.labels(10000)
#mnist.train.images.ndim(2), mnist.train.images.shape(55000, 784), mnist.train.images.size(43120000), mnist.train.images.dtype(float32), mnist.train.images.itemsize(4)
#mnist.test.images.ndim(2), mnist.test.images.shape(10000, 784), mnist.test.images.size(7840000), mnist.train.images.dtype(float32), mnist.train.images.itemsize(4)

test_images_file_path = "./MNIST_data/test-image"
...
#with open(test_images_file_path, "r") as test_images_file:
#    magic, num, rows, columns = struct.unpack(">IIII", test_images_file.read(16))
#    test_images = np.fromfile(test_images_file, dtype="uint8").reshape(10000, rows * columns).astype("float32")
...
for i in range(36000):
    ...
    if i % 100 == 0:
        ...
        out_file = open("./answer/" + str(i) + ".csv", "wb")
