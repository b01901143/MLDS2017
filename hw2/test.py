...
video_path = './data/training/video'

video_train_feat_path = './data/training/feat'
video_test_feat_path = './data/testing/MLDS_hw2_time_limited/feat'

video_train_data_path = './data/training/label/final_label.csv'
video_test_data_path = './data/testing/label/final_label.csv'
...
def train():
    ...
    for epoch in range(0, n_epochs):
        ...
        for start, end in zip(
            ...
            current_caption_matrix = np.zeros( (len(current_caption_ind), n_caption_lstm_step), dtype=np.int )
...
def test(model_path='./models/model-10'):
    test_data = get_video_test_data(video_test_data_path, video_test_feat_path)
    test_videos = test_data['video_path'].unique()

    ixtoword = pd.Series(np.load('./data/training/ixtoword.npy').tolist())

    bias_init_vector = np.load('./data/training/bias_init_vector.npy')
...
# def train1():
#     # get_video_train_data('training_data/feat/')
#     # exit()
#     train_data = get_video_train_data(video_train_data_path, video_train_feat_path)
#     train_captions = train_data['Description'].values
#     test_data = get_video_test_data(video_test_data_path, video_test_feat_path)
