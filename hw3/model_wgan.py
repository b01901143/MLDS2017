...
class GAN:
	...
	def buildTrainModel(self):
		...
		#loss
		t_g_loss = tf.reduce_mean(-fake_image_logits)
		d_loss_1 = tf.reduce_mean(-real_image_logits)
		d_loss_2 = tf.reduce_mean(wrong_image_logits)
		d_loss_3 = tf.reduce_mean(fake_image_logits)
