...
def train():
	...
	#optimizer
	g_optimizer = tf.train.RMSPropOptimizer(learning_rate = 0.0001).minimize(loss_tensor['g_loss'], var_list=variable_tensor['g_variable'])
	...
	d_optimizer = tf.train.AdamOptimizer(learning_rate = 0.0001).minimize(loss_tensor['d_loss'], var_list=variable_tensor['d_variable'])
